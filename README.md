...
This generated compatibility distribution is synchronized from `packs/engineering/repo-doctor/`. It contains 27 scoped workflow and specialist engineering Skills:
...
|---|---|---:|---|
| `rd-*` | Repo Doctor | 27 | Software engineering routing, clarification, prototyping, architecture analysis, diagnosis, planning, safe changes, verification, and session transfer. |
...
The current canonical inventory is 4 active Packs with 40 active Skills, plus 1 template Pack containing 1 template Skill. Three plugin distributions contain 37 Skills in total; the build emits 37 matching ChatGPT ZIPs and 7 regular cross-platform targets. Validation discovers the Pack and Skill sets from manifests rather than relying on these documentation counts.

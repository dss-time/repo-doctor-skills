...
本目录对应项目版本 `0.6.0` 的当前工作树，收录 4 个 active Pack 中的 40 个 active Skill。当前其中 37 个配置了插件兼容产物和独立 ChatGPT ZIP，3 个仅进入常规跨平台构建产物。相邻 Skill 来自 300 条 activation contract 以及 canonical description 中明确提到的 Skill。

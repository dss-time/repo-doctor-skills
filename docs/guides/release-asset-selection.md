...
|---|---|---|
| Route an engineering request | `rd-repo-doctor-router-v0.5.0.zip` | `repo-doctor-router` |
| Diagnose a qualified non-CI runtime bug | `rd-bug-root-cause-analysis-v0.5.0.zip` | `bug-root-cause-analysis` |
| Review a code change | `rd-safe-code-review-v0.5.0.zip` | `safe-code-review` |
| Analyze architecture friction | `rd-architecture-deepening-analysis-v0.5.0.zip` | `architecture-deepening-analysis` |
| Draft an evidence-aware report | `pt-report-writer-v0.5.0.zip` | `report-writer` |
| Review a Word or general document | `pt-document-review-v0.5.0.zip` | `document-review` |
| Review a PDF | `pt-pdf-review-v0.5.0.zip` | `pdf-review` |
| Clean Excel or other spreadsheet data | `pt-spreadsheet-data-cleaning-v0.5.0.zip` | `spreadsheet-data-cleaning` |
| Create a presentation outline | `pt-presentation-outline-v0.5.0.zip` | `presentation-outline` |
| Author a repository-standard Skill | `sm-skill-authoring-v0.5.0.zip` | `skill-authoring` |
| Audit Skill release quality | `sm-skill-quality-audit-v0.5.0.zip` | `skill-quality-audit` |

Other assets follow the same published naming rule:

- `rd-<repo-doctor-slug>-v0.5.0.zip`;
- `pt-<productivity-slug>-v0.5.0.zip`;
- `sm-<skill-maintainer-slug>-v0.5.0.zip`.
...
gh release download v0.5.0 \
  ...
  -p 'rd-repo-doctor-router-v0.5.0.zip' \
  -p 'Repo-Doctor-Skills-v0.5.0-RELEASE_MANIFEST.txt' \
  -p 'SHA256SUMS-v0.5.0.txt'
```

`SHA256SUMS-v0.5.0.txt` covers all 37 Skill ZIPs. If only one ZIP is present locally, verify that file against its matching line:

```bash
expected=$(awk '$2 == "rd-repo-doctor-router-v0.5.0.zip" { print $1 }' SHA256SUMS-v0.5.0.txt)
actual=$(shasum -a 256 rd-repo-doctor-router-v0.5.0.zip | awk '{ print $1 }')
...
- Pin stable use to `v0.5.0`; use `main` only for deliberate development testing.

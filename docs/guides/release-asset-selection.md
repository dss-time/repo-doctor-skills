...
|---|---|---|
| Route an engineering request | `rd-repo-doctor-router-v0.5.1.zip` | `repo-doctor-router` |
| Diagnose a qualified non-CI runtime bug | `rd-bug-root-cause-analysis-v0.5.1.zip` | `bug-root-cause-analysis` |
| Review a code change | `rd-safe-code-review-v0.5.1.zip` | `safe-code-review` |
| Analyze architecture friction | `rd-architecture-deepening-analysis-v0.5.1.zip` | `architecture-deepening-analysis` |
| Draft an evidence-aware report | `pt-report-writer-v0.5.1.zip` | `report-writer` |
| Review a Word or general document | `pt-document-review-v0.5.1.zip` | `document-review` |
| Review a PDF | `pt-pdf-review-v0.5.1.zip` | `pdf-review` |
| Clean Excel or other spreadsheet data | `pt-spreadsheet-data-cleaning-v0.5.1.zip` | `spreadsheet-data-cleaning` |
| Create a presentation outline | `pt-presentation-outline-v0.5.1.zip` | `presentation-outline` |
| Author a repository-standard Skill | `sm-skill-authoring-v0.5.1.zip` | `skill-authoring` |
| Audit Skill release quality | `sm-skill-quality-audit-v0.5.1.zip` | `skill-quality-audit` |
...
`SHA256SUMS-v0.5.1.txt` covers all 37 Skill ZIPs. If only one ZIP is present locally, verify that file against its matching line:
...
- Pin stable use to `v0.5.1`; use `main` only for deliberate development testing.

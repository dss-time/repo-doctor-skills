...
|---|---|---|
| 路由工程请求 | `rd-repo-doctor-router-v0.6.0.zip` | `repo-doctor-router` |
| 诊断满足前提的非 CI 运行时 Bug | `rd-bug-root-cause-analysis-v0.6.0.zip` | `bug-root-cause-analysis` |
| 审查代码改动 | `rd-safe-code-review-v0.6.0.zip` | `safe-code-review` |
| 分析架构摩擦 | `rd-architecture-deepening-analysis-v0.6.0.zip` | `architecture-deepening-analysis` |
| 撰写证据感知报告 | `pt-report-writer-v0.6.0.zip` | `report-writer` |
| 审查 Word 或一般文档 | `pt-document-review-v0.6.0.zip` | `document-review` |
| 审查 PDF | `pt-pdf-review-v0.6.0.zip` | `pdf-review` |
| 清洗 Excel 或其他表格数据 | `pt-spreadsheet-data-cleaning-v0.6.0.zip` | `spreadsheet-data-cleaning` |
| 创建演示文稿大纲 | `pt-presentation-outline-v0.6.0.zip` | `presentation-outline` |
| 创建仓库标准 Skill | `sm-skill-authoring-v0.6.0.zip` | `skill-authoring` |
| 审计 Skill 发布质量 | `sm-skill-quality-audit-v0.6.0.zip` | `skill-quality-audit` |
...
`SHA256SUMS-v0.6.0.txt` 覆盖全部 37 个 Skill ZIP。如果本地只下载了一个 ZIP，可核对对应行：
...
- 稳定使用固定到 `v0.6.0`；只有明确测试开发内容时使用 `main`。

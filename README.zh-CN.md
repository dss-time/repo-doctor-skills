...
- [执行模式](docs/guides/execution-modes.zh-CN.md)：了解 fast、standard、audit、简单请求快速通道和仅显式调用 Skill。
...
- [Skill 运行效率分析](docs/research/skill-runtime-efficiency-analysis.zh-CN.md)
- [性能契约验证](tests/reports/skill-performance-validation.md)

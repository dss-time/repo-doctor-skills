...
for (const relativePath of ["docs/RELEASE_NOTES_0.5.1.md", "docs/RELEASE_NOTES_0.5.1.zh-CN.md"]) {
  const content = read(relativePath);
  for (const term of ["0.5.1", "0.5.0", "30/30", "27/30", "v0.5.1", "SHA256SUMS", "release-asset-selection"]) {
    if (!content.includes(term)) fail(`${relativePath}: missing v0.5.1 release term ${term}`);
  }
}
